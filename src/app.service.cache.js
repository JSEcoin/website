...
const cacheService = {
	...
	networkFirstStrategy: (path, cacheTime) => new Promise((resolve, reject) => {
			request
				.get(path)
				.then((response) => {
	...
	offlineFirstStrategy: (path, cacheTime) => new Promise((resolve, reject) => {
	...
	get: (path, cacheTime) => new Promise((resolve, reject) => {
