...
export default {
	...
	data() {
		...
		return {
			...
			timeline: {
				months: [
					this.$t('segment.interactiveTimeline.month_january'),
					this.$t('segment.interactiveTimeline.month_february'),
					this.$t('segment.interactiveTimeline.month_march'),
					this.$t('segment.interactiveTimeline.month_april'),
					this.$t('segment.interactiveTimeline.month_may'),
					this.$t('segment.interactiveTimeline.month_june'),
					this.$t('segment.interactiveTimeline.month_july'),
					this.$t('segment.interactiveTimeline.month_august'),
					this.$t('segment.interactiveTimeline.month_september'),
					this.$t('segment.interactiveTimeline.month_october'),
					this.$t('segment.interactiveTimeline.month_november'),
					this.$t('segment.interactiveTimeline.month_december'),
				],
